	...
	">
		...
		<div class="row form-group">
			...
			<div class="col-md-12">
				...
				<div class="col-md-9">
					<div class="category">
						<a id="cat-cafe" href="#">CAFE&nbsp;</a> <a id="cat-dessert"
							href="#">DESSERT&nbsp;</a> <a id="cat-bob" href="#">RESTAURANT&nbsp;</a>
		...
		<div class="row form-group">
			...
			<div class="col-md-6 col-sm-6">
				...
				<p>
					...
					<input type=file id="filename" name="filename" class="btn btn-primary btn-outline">
				</p>
			</div>
		</div>
		<hr>
