					...
					for(var i=0; i<9; i++){
						mainContents+=
							"<div class=\"col-md-4 text-center\">" /* animate-box - 애니메이션 클래스가 안들어감*/
								+"<a class=\"work\" href=\"view.do?cno="+jsonInfo.contents[i].cno+"\">"
									+"<div id=\"main-con-img"+[i]+"\" class=\"work-grid\">"
										+"<div class=\"inner\">"
											+"<div class=\"desc\">"
												+"<h3 id=\"main-name\">name - "+jsonInfo.contents[i].name+"</h3>"
													+"<span id=\"main-cat\" class=\"cat\">category - "+jsonInfo.contents[i].cat+"</span><br>"
													+"<span id=\"main-store_name\" class=\"cat\">stroe_name -"
													+jsonInfo.contents[i].store_name+"</span><br> <span id=\"main-review\""
													+"class=\"cat\">review - "+jsonInfo.contents[i].review+"</span><br> <span"
													+"id=\"main-point\" class=\"cat\">point - "+jsonInfo.contents[i].point+"</span><br>"
												+"</div>"
											+"</div>"
										+"</div>"
									+"</a>"
