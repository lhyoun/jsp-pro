	...
	<div class="container">
		<div class="row copyright">
			<div class="col-md-12 text-center">
				<p>
					<small class="block">Designed by HAYOUN</small> <small
						class="block">Email&nbsp;<a href="#">gkdbsx@naver.com</a></small>
				</p>
...
<script type="text/javascript"
	src="//dapi.kakao.com/v2/maps/sdk.js?appkey=key&libraries=services"></script>
...
/* 	$(".filter-list li").on('click', function() {
	...
	/* main page contnet(사진9개 있는거)관련 main으로 옮김 */
