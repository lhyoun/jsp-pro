...
public class ContentServlet extends HttpServlet {
	...
	private static final String FILE_REPO = "C:\\Users\\Samsung\\eclipse-workspace\\FoodigationPro2\\WebContent\\images\\temp";
	...
	private void doHandle(HttpServletRequest request, HttpServletResponse response)
		...
		/* 콘텐츠 추가 로직 */ 
			...
			String imagename = ContentMap.get("filename"); 
			System.out.println("aaa"+imagename);
			
			
			/* 조회수, 작성일, 번호는 default로 들어간다 */
			boolean flag = ContDao.getInstance().insert(new Cont(name, review, store_name, point, cat, writer, map, imagename));
